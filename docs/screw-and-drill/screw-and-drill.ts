document.addEventListener("DOMContentLoaded", function (event) {
    function updateSizes() {
        while (sizes.options.length != 0) sizes.options.remove(0)
        let options: string[] = [];
    ...
    function updateResult() {
        function updateSpan(span: HTMLSpanElement, data: string) { span.innerHTML = data }

        let clearanceClose: string = "[todo]"
        let clearanceFree: string = "[todo]"
        let tap50: string = "[todo]"
        let tap75: string = "[todo]"
    ...
    // Init HTML consts
    const region: HTMLSelectElement = document.getElementById("region") as HTMLSelectElement
    const sizes: HTMLSelectElement = document.getElementById("sizes") as HTMLSelectElement
    const neededClearanceClose: HTMLSpanElement = document.getElementById("needed-clearance-close") as HTMLSpanElement
    const neededClearanceFree: HTMLSpanElement = document.getElementById("needed-clearance-free") as HTMLSpanElement
    const neededTap50: HTMLSpanElement = document.getElementById("needed-tap-50") as HTMLSpanElement
    const neededTap75: HTMLSpanElement = document.getElementById("needed-tap-75") as HTMLSpanElement
